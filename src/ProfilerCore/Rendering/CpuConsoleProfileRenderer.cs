...
internal sealed class CpuConsoleProfileRenderer
{
    ...
    public CpuConsoleProfileRenderer(
        Theme theme,
        ...
        MemoryProfileResult? memoryResults = null)
    {
        ...
        ProfilerConsoleRenderHelpers.WriteProfileHeader("CPU PROFILE", request);
        ...
        var filteredAll = allFunctions.Where(entry =>

...
internal sealed class HeapConsoleProfileRenderer
{
    private readonly Theme _theme;

    public HeapConsoleProfileRenderer(Theme theme)
    {
        _theme = theme;
    }
    ...
    public void Print(HeapProfileResult? results, ProfileRenderRequest request)
    {
        ...
        ProfilerConsoleRenderHelpers.WriteProfileHeader("HEAP SNAPSHOT", request);
